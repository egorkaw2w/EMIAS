...
namespace A2test.Controllers
{
    ...
    public class AdminTablesController : ControllerBase
    {
        ...
        public AdminTablesController(EmiasContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<AdminTable>> PostAdminTable(AdminTable adminTable)
        {
            ...
            return CreatedAtAction("GetAdminTable", new { id = adminTable.Id }, adminTable);
        }
        ...
        {
            return _context.AdminTables.Any(e => e.Id == id);
        }
    }
}
